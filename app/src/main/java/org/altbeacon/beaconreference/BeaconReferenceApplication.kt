...
class BeaconReferenceApplication: Application() {
    ...
    // library.  This string key must be unique for each region you define, and the ame uniqueID
    // must be used to tell the library to start and stop beacon ranging and monitoring.
    val wildcardIBeaconRegion = BeaconRegion("everyIBeaconRegion", IBeaconParser(), null, null, null)
    ...
    //val everyEddystoneUidBeaconRegion = BeaconRegion("everyEddystoneUidBeaconRegion", AltBeaconParser(), null, null, null)
